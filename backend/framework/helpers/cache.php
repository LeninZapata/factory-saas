 ...
 *
 *    Ejemplos:
 *    ✅ cache::set('global_php_version_valid', true)
 *    ✅ cache::set('global_app_config', [...])
 *    ✅ cache::set('global_maintenance_mode', false)
 *
 ...
 *
 *    Ejemplos:
 *    ✅ cache::set('auth_session_abc123', $sessionData)
 *    ✅ cache::set('user_permissions_5', ['read', 'write'])
 *    ✅ cache::set('user_config_10', [...])
 *
 * ═══════════════════════════════════════════════════════════════════════════
...
class cache {
   ...
   * cache::get('global_php_version_valid')     → $_SESSION ⚡ 0.01ms
   * cache::get('global_app_config')            → $_SESSION ⚡
   * cache::get('global_timezone')              → $_SESSION ⚡
   *
   * ✅ NO USAR 'global_' para datos específicos de usuarios/tokens:
   * cache::get('auth_session_abc123')          → Archivo ✓ 0.1ms (funciona con Bearer)
   * cache::get('user_permissions_5')           → Archivo ✓
   * cache::get('user_config_10')               → Archivo ✓
   *
   * ¿POR QUÉ?
 ...
 * $isValid = cache::remember('global_php_version_valid', function() {
