<?php
// middle/routes/docs-entry.php
// Genera fe-entry.prompt.md — documentación del arranque frontend
// Cubre: index.html, appConfig, modos standalone vs multi-instancia (WordPress)
// Este módulo es 100% contenido estático curado (no extrae @doc-start de archivos)
// Se invoca desde docs.php junto al resto de módulos frontend

function docsEntry($promptsPath, $copilotPath) {

  $generated = [];

  // ============================================================
  // CONTENIDO CURADO — fe-entry.prompt.md
  // ============================================================

  $content = <<<'FE_ENTRY_END'
...
FE_ENTRY_END;
  ...
  // ── Generar fe-entry.prompt.md ───────────────────────────────
  $md   = [];
  $md[] = '# Frontend — Entry Point & Arranque';
  $md[] = '';
  $md[] = '> index.html, appConfig, modos standalone vs multi-instancia (WordPress), secuencia de arranque.';
  ...
  file_put_contents($promptsPath . '/fe-entry.prompt.md', implode("\n", $md));
  $generated[] = '.github/prompts/fe-entry.prompt.md';
